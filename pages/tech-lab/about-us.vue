<template>
  ...
  >
    ...
    <CommonCard custom-class="hero-banner text-white q-mb-xl q-pa-xl">
    ...
    <!-- Philosophy Section -->
    <CommonCard flat bordered custom-class="q-pa-lg q-mb-xl bg-white shadow-lg">
    ...
    <CommonCard flat bordered custom-class="q-pa-lg q-mb-xl feature-section">
      <q-card-section class="text-center">
        ...
        <AnimationSlideOnceGroup
          direction="up"
          class="row q-col-gutter-lg items-stetch"
        >
          <AnimationSlideOnce
          ...
          >
            <CommonCard
              flat
              bordered
              custom-class="feature-card full-height text-center hover-card"
            >
