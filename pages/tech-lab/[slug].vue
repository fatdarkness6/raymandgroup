<template>
  <div class="dynamic-page z-2 relative" v-if="pageContent">
...
const renderButtonDatas = [
  { label: t("common.close"), color: "red", action: "close" },
  { label: t("common.submit"), color: "blue", action: "submit" },
];
</script>
<style scoped>
